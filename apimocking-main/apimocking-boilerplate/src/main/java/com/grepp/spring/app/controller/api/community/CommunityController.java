...
public class CommunityController {
    ...
    List<CommunityCommentResponse> comments = List.of(
        new CommunityCommentResponse(0, "댓글 내용0", "댓글 작성자0", "profile0.jpg", "칭호0","휘장0", "2025-07-10T09:10:00", "2025-07-10T09:20:00"),
        new CommunityCommentResponse(1, "댓글 내용1", "댓글 작성자1", "profile1.jpg", "칭호1","휘장1", "2025-07-10T10:15:00", "2025-07-10T10:45:00"),
        new CommunityCommentResponse(2, "댓글 내용2", "댓글 작성자2", "profile2.jpg", "칭호2","휘장2", "2025-07-10T08:00:00", "2025-07-10T08:05:00"),
        new CommunityCommentResponse(3, "댓글 내용3", "댓글 작성자3", "profile3.jpg", "칭호3","휘장3", "2025-07-10T11:00:00", "2025-07-10T11:30:00"),
        new CommunityCommentResponse(4, "댓글 내용4", "댓글 작성자4", "profile4.jpg", "칭호4","휘장4", "2025-07-10T13:05:00", "2025-07-10T13:25:00"),
        new CommunityCommentResponse(5, "댓글 내용5", "댓글 작성자5", "profile5.jpg", "칭호5","휘장5", "2025-07-10T07:40:00", "2025-07-10T07:45:00"),
        new CommunityCommentResponse(6, "댓글 내용6", "댓글 작성자6", "profile6.jpg", "칭호6","휘장6", "2025-07-10T14:10:00", "2025-07-10T14:40:00"),
        new CommunityCommentResponse(7, "댓글 내용7", "댓글 작성자7", "profile7.jpg", "칭호7","휘장7", "2025-07-10T15:00:00", "2025-07-10T15:30:00"),
        new CommunityCommentResponse(8, "댓글 내용8", "댓글 작성자8", "profile8.jpg", "칭호8","휘장8", "2025-07-10T09:20:00", "2025-07-10T09:50:00"),
        new CommunityCommentResponse(9, "댓글 내용9", "댓글 작성자9", "profile9.jpg", "칭호9","휘장9", "2025-07-10T12:00:00", "2025-07-10T12:15:00"),
        new CommunityCommentResponse(10, "댓글 내용10", "댓글 작성자10", "profile10.jpg", "칭호10","휘장10","2025-07-10T12:10:00", "2025-07-10T12:45:00")
    );

    List<CommunityTopPostResponse> topPosts = List.of(
        new CommunityTopPostResponse(5, "작성자 닉네임5", "칭호5", "휘장5", "profile5.jpg", "게시물 제목5", "2025-07-09T07:55:00"),
        new CommunityTopPostResponse(7, "작성자 닉네임7", "칭호7", "휘장7", "profile7.jpg", "게시물 제목7", "2025-07-09T16:40:00"),
        new CommunityTopPostResponse(2, "작성자 닉네임2", "칭호2", "휘장2", "profile2.jpg", "게시물 제목2", "2025-07-10T08:12:00"),
        new CommunityTopPostResponse(9, "작성자 닉네임9", "칭호9", "휘장9", "profile9.jpg", "게시물 제목9", "2025-07-10T12:05:00"),
        new CommunityTopPostResponse(0, "작성자 닉네임0", "칭호0", "휘장0", "profile0.jpg", "게시물 제목0", "2025-07-10T11:32:00"),
        new CommunityTopPostResponse(10, "작성자 닉네임10", "칭호10", "휘장10", "profile10.jpg", "게시물 제목10", "2025-07-09T20:20:00"),
        new CommunityTopPostResponse(4, "작성자 닉네임4", "칭호4", "휘장4", "profile4.jpg", "게시물 제목4", "2025-07-10T13:45:00"),
        new CommunityTopPostResponse(6, "작성자 닉네임6", "칭호6", "휘장6", "profile6.jpg", "게시물 제목6", "2025-07-10T10:22:00"),
        new CommunityTopPostResponse(11, "작성자 닉네임11", "칭호11", "휘장11", "profile11.jpg", "게시물 제목11", "2025-07-10T15:30:00"),
        new CommunityTopPostResponse(1, "작성자 닉네임1", "칭호1", "휘장1", "profile1.jpg", "게시물 제목1", "2025-07-09T14:55:00")
    );
